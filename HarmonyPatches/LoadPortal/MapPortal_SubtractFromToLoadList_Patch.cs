...
//
// HarmonyPatches/LoadTransporters/MapPortal_SubtractFromToLoadList_Patch.cs
...
{
    /// <summary>
    /// Intercepts the MapPortal's accounting logic to provide a more robust
    /// and precise way of subtracting loaded items from the to-load list.
    /// </summary>
    [HarmonyPatch(typeof(MapPortal), "SubtractFromToLoadList")]
    public static class MapPortal_SubtractFromToLoadList_Patch
    {

        ...
        public static Toil Create()
        {
            ...
            toil.initAction = () =>
            {
                ...
                foreach (var tr in nearbyTransporters)
                {
                    ...
                    IManagedLoadable groupLoadable = LoadTransportersAdapter.TryCreate(tr);
                ...
                if (bestNextTransporter != null)
                {
                    ...
                    IManagedLoadable groupLoadable = LoadTransportersAdapter.TryCreate(bestNextTransporter);
